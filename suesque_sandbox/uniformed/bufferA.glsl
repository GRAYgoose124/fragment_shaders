...
// Input Uniforms
#iUniform float NU = 0.50 in { -1.0, 1.0 } 
...
#define RG OP(r, g, b)
#define GB OP(g, b, r)
#define P1 ((BR * NU) + cos(RG * MU)) * ((BR * NU) - sin(GB * XI))
#define P2 ((RG * NU) + cos(GB * MU)) * ((RG * NU) - sin(BR * XI))
#define P3 ((GB * NU) + cos(BR * MU)) * ((GB * NU) - sin(RG * XI))
